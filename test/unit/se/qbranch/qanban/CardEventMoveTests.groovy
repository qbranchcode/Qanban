...
class CardEventMoveTests extends GrailsUnitTestCase {
  ...
  protected void setUp() {
    ...
    board = new Board().addToPhases(new Phase(name: "test", cardLimit: 5)).addToPhases(new Phase(name: "other phase", cardLimit: 3)).addToPhases(new Phase(name: "thid phase", cardLimit: 3)).save()
