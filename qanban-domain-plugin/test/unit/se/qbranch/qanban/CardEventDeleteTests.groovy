...
class CardEventDeleteTests extends GrailsUnitTestCase {
    ...
    void testDeletCard() {
        ...
        def deleteEvent = new CardEventDelete(card: card2onPhase1,eventCreator: user1)
        ...
        assertEquals 1, phase1.cards.size()
