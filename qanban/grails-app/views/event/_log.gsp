      ...
      <table id="logTable" border="0" cellspacing="0" class="tableContainer">
        <thead class="logTableHeader fixedHeader">
          <tr>
            ...
            <th><a href="${createLink(controller:'mainView',action:'showLogBody',params:['sort':'eventCreator','board.id':board.id])}" class="ajaxSortableColumn order_desc"><g:message code="log.user"/></a></th>
